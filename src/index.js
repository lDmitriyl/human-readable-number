module.exports = function toReadable (number) {
    ...
    arr.length == 2 && arr[1] == 0 ? array.push(decades[+arr[0]]):
    ...
    arr.length == 3 && arr[1] == 0 ? array.push(TwentyNumbers[+arr[0]],"hundred",TwentyNumbers[+arr[2]]):
    arr.length == 3 && arr[1] == 1 ? array.push(TwentyNumbers[+arr[0]],"hundred",TwentyNumbers[10 + +arr[2]]):
    arr.length == 3 && arr[2] == 0 ? array.push(TwentyNumbers[+arr[0]],"hundred",decades[+arr[1]]):
